...
public class MaquinaTurring {
	...
	public boolean addTransition(String estado1, char lerSimbolo, String estado2, char escreverSimbolo, boolean direcao)
	{
		...
		while ( iteradorTransicao.hasNext() && conflito == false)
	    {
		...
		if (conflito == true){
			...
			Transicao novaTransicao = new Transicao(estado1, lerSimbolo, estado2, escreverSimbolo, direcao);
